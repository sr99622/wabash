#********************************************************************
# wabash/gui/components/layout.py
#
...
class Layout():
    ...
    def removeOrdinal(self, name: str):
        if name in self.ordinals:
            del self.ordinals[name]

    def addOrdinal(self, name: str):
        if not name in self.ordinals:
            self.ordinals[name] = self.nextOrdinal()
