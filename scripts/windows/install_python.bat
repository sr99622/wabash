...
if /i "%PYVER%"=="310" (
    ...
    set PYFILE=python-3.10.19-amd64.exe
    set PYURL=https://www.python.org/ftp/python/3.10.19/python-3.10.19-amd64.exe
) else if /i "%PYVER%"=="311" (
    set PYNAME=Python311
    set PYFILE=python-3.11.14-amd64.exe
    set PYURL=https://www.python.org/ftp/python/3.11.14/python-3.11.14-amd64.exe
) else if /i "%PYVER%"=="312" (
    set PYNAME=Python312
    set PYFILE=python-3.12.12-amd64.exe
    set PYURL=https://www.python.org/ftp/python/3.12.12/python-3.12.12-amd64.exe
) else if /i "%PYVER%"=="313" (
